 ...
 * ReferralCodeOrder
 *
 * @ORM\Table(name="plg_referral_code_order")
 * @ORM\Entity(repositoryClass="Plugin\ReferralCode\Repository\ReferralCodeOrderRepository")
 */
class ReferralCodeOrder extends AbstractEntity
{
    /**
     * @var int
     *
