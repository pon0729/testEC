...
use Plugin\YamatoSubscription\Entity\Traits\YamatoPayment4\ShippingTrait;
 ...
 *
 * @ORM\Table(name="plg_yamato_subs_users_shipping")
 * @ORM\Entity(repositoryClass="Plugin\YamatoSubscription\Repository\YamatoSubsUsersShippingRepository")
 */
class YamatoSubsUsersShipping extends AbstractEntity
{
    use ShippingTrait;
     ...
     *
     * @ORM\ManyToOne(targetEntity="YamatoSubsUsersOrder", inversedBy="YamatoSubsUsersShippings")
     * @ORM\JoinColumns({
     ...
     *
     * @ORM\OneToMany(targetEntity="YamatoSubsUsersOrderItem", mappedBy="YamatoSubsUsersShipping")
     */
