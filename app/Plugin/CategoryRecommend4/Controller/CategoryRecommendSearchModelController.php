...
/**
 * Class CategoryRecommendSearchModelController.
 */
class CategoryRecommendSearchModelController extends AbstractController
{
    /**
    ...
    /**
     * CategoryRecommendSearchModelController constructor.
     *
     ...
     *
     * @return array
     * @Route("/%eccube_admin_route%/product/category/recommend/search/product", name="plugin_category_recommend_search_product")
     * @Route("/%eccube_admin_route%/product/category/recommend/search/product/page/{page_no}", requirements={"page_no" = "\d+"}, name="plugin_category_recommend_search_product_page")
     * @Template("@CategoryRecommend4/admin/search_product.twig")
     */
