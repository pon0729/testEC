...
class EccubeDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($rawPathinfo)
    {
        ...
        elseif (0 === strpos($pathinfo, '/retail_admin')) {
            // admin_login
            ...
            elseif (0 === strpos($pathinfo, '/retail_admin/c')) {
                ...
                if (0 === strpos($pathinfo, '/retail_admin/content')) {
                    ...
                    // admin_content_deliveryplus_detail
                    if ('/retail_admin/content/deliveryplus/detail' === $pathinfo) {
                        $ret = array (  '_controller' => 'Plugin\\DeliveryPlus4\\Controller\\Admin\\DeliveryPlusDesignController::detailDesign',  '_route' => 'admin_content_deliveryplus_detail',);
                        $requiredSchemes = array (  'https' => 0,);
                        if (!isset($requiredSchemes[$context->getScheme()])) {
                            if ('GET' !== $canonicalMethod) {
                                goto not_admin_content_deliveryplus_detail;
                            }

                            return array_replace($ret, $this->redirect($rawPathinfo, 'admin_content_deliveryplus_detail', key($requiredSchemes)));
                        }

                        return $ret;
                    }
                    not_admin_content_deliveryplus_detail:

                    // admin_content_deliveryplus_cart
                    if ('/retail_admin/content/deliveryplus/cart' === $pathinfo) {
                        $ret = array (  '_controller' => 'Plugin\\DeliveryPlus4\\Controller\\Admin\\DeliveryPlusDesignController::cartDesign',  '_route' => 'admin_content_deliveryplus_cart',);
                        $requiredSchemes = array (  'https' => 0,);
                        if (!isset($requiredSchemes[$context->getScheme()])) {
                            if ('GET' !== $canonicalMethod) {
                                goto not_admin_content_deliveryplus_cart;
                            }

                            return array_replace($ret, $this->redirect($rawPathinfo, 'admin_content_deliveryplus_cart', key($requiredSchemes)));
                        }

                        return $ret;
                    }
                    not_admin_content_deliveryplus_cart:
            ...
            elseif (0 === strpos($pathinfo, '/retail_admin/plugin')) {
                // delivery_plus4_admin_config
                if ('/retail_admin/plugin/delivery_plus/config' === $pathinfo) {
                    $ret = array (  '_controller' => 'Plugin\\DeliveryPlus4\\Controller\\Admin\\ConfigController::index',  '_route' => 'delivery_plus4_admin_config',);
                    $requiredSchemes = array (  'https' => 0,);
                    if (!isset($requiredSchemes[$context->getScheme()])) {
                        if ('GET' !== $canonicalMethod) {
                            goto not_delivery_plus4_admin_config;
                        }

                        return array_replace($ret, $this->redirect($rawPathinfo, 'delivery_plus4_admin_config', key($requiredSchemes)));
                    }

                    return $ret;
                }
                not_delivery_plus4_admin_config:
