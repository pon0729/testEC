...
class Delivery extends \Eccube\Entity\Delivery implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Eccube\\Entity\\Delivery' . "\0" . 'id', '' . "\0" . 'Eccube\\Entity\\Delivery' . "\0" . 'name', '' . "\0" . 'Eccube\\Entity\\Delivery' . "\0" . 'service_name', '' . "\0" . 'Eccube\\Entity\\Delivery' . "\0" . 'description', '' . "\0" . 'Eccube\\Entity\\Delivery' . "\0" . 'confirm_url', '' . "\0" . 'Eccube\\Entity\\Delivery' . "\0" . 'sort_no', '' . "\0" . 'Eccube\\Entity\\Delivery' . "\0" . 'visible', '' . "\0" . 'Eccube\\Entity\\Delivery' . "\0" . 'create_date', '' . "\0" . 'Eccube\\Entity\\Delivery' . "\0" . 'update_date', '' . "\0" . 'Eccube\\Entity\\Delivery' . "\0" . 'PaymentOptions', '' . "\0" . 'Eccube\\Entity\\Delivery' . "\0" . 'DeliveryFees', '' . "\0" . 'Eccube\\Entity\\Delivery' . "\0" . 'DeliveryTimes', '' . "\0" . 'Eccube\\Entity\\Delivery' . "\0" . 'Creator', '' . "\0" . 'Eccube\\Entity\\Delivery' . "\0" . 'SaleType', '' . "\0" . 'Eccube\\Entity\\Delivery' . "\0" . 'deliveryplus_weight_min', '' . "\0" . 'Eccube\\Entity\\Delivery' . "\0" . 'deliveryplus_weight_max', '' . "\0" . 'Eccube\\Entity\\Delivery' . "\0" . 'deliveryplus_size_min', '' . "\0" . 'Eccube\\Entity\\Delivery' . "\0" . 'deliveryplus_size_max', '' . "\0" . 'Eccube\\Entity\\Delivery' . "\0" . 'deliveryplus_subtotal_min', '' . "\0" . 'Eccube\\Entity\\Delivery' . "\0" . 'deliveryplus_subtotal_max'];
        }
  ...
  3 => 'AnnotationReader',
    ...
    public function setDeliveryplusWeightMin($weightMin)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDeliveryplusWeightMin', [$weightMin]);

        return parent::setDeliveryplusWeightMin($weightMin);
    }
    ...
    public function setDeliveryplusWeightMax($weightMax)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDeliveryplusWeightMax', [$weightMax]);

        return parent::setDeliveryplusWeightMax($weightMax);
    }
    ...
    public function setDeliveryplusSizeMin($sizeMin)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDeliveryplusSizeMin', [$sizeMin]);

        return parent::setDeliveryplusSizeMin($sizeMin);
    }
    ...
    public function setDeliveryplusSizeMax($sizeMax)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDeliveryplusSizeMax', [$sizeMax]);

        return parent::setDeliveryplusSizeMax($sizeMax);
    }
    ...
    public function setDeliveryplusSubtotalMin($subtotalMin)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDeliveryplusSubtotalMin', [$subtotalMin]);

        return parent::setDeliveryplusSubtotalMin($subtotalMin);
    }
    ...
    public function getDeliveryplusSubtotalMin()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDeliveryplusSubtotalMin', []);

        return parent::getDeliveryplusSubtotalMin();
    }
    ...
    public function setDeliveryplusSubtotalMax($subtotalMax)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDeliveryplusSubtotalMax', [$subtotalMax]);

        return parent::setDeliveryplusSubtotalMax($subtotalMax);
    }
    ...
    public function getDeliveryplusSubtotalMax()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDeliveryplusSubtotalMax', []);

        return parent::getDeliveryplusSubtotalMax();
    }
