 ...
 */
class YamatoSubs extends \Plugin\YamatoSubscription\Entity\YamatoSubs implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubs' . "\0" . 'id', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubs' . "\0" . 'last_subs_history_id', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubs' . "\0" . 'subs_month_period', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubs' . "\0" . 'credit_count', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubs' . "\0" . 'delivery_count', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubs' . "\0" . 'credit_card_key', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubs' . "\0" . 'cancelled_date', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubs' . "\0" . 'create_date', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubs' . "\0" . 'update_date', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubs' . "\0" . 'visible', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubs' . "\0" . 'YamatoSubsHistories'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (YamatoSubs $proxy) {
    ...
    public function getLastSubsHistoryId()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getLastSubsHistoryId', []);

        return parent::getLastSubsHistoryId();
    }
    ...
    public function setLastSubsHistoryId($last_subs_history_id)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setLastSubsHistoryId', [$last_subs_history_id]);

        return parent::setLastSubsHistoryId($last_subs_history_id);
    }
    ...
    public function setCreditCount($credit_count)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCreditCount', [$credit_count]);

        return parent::setCreditCount($credit_count);
    }
    ...
    public function getCreditCardKey()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCreditCardKey', []);

        return parent::getCreditCardKey();
    }
    ...
    public function setCreditCardKey($credit_card_key)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCreditCardKey', [$credit_card_key]);

        return parent::setCreditCardKey($credit_card_key);
    }
    ...
    public function getCancelledDate()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCancelledDate', []);

        return parent::getCancelledDate();
    }
    ...
    public function setCancelledDate($cancelled_date)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCancelledDate', [$cancelled_date]);

        return parent::setCancelledDate($cancelled_date);
    }
    ...
    public function getYamatoSubsHistories()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getYamatoSubsHistories', []);

        return parent::getYamatoSubsHistories();
    }
    ...
    public function setYamatoSubsHistories($YamatoSubsHistories)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setYamatoSubsHistories', [$YamatoSubsHistories]);

        return parent::setYamatoSubsHistories($YamatoSubsHistories);
    }

    /**
     * {@inheritDoc}
     */
    public function addYamatoSubsHistory(\Plugin\YamatoSubscription\Entity\YamatoSubsHistory $YamatoSubsHistory)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addYamatoSubsHistory', [$YamatoSubsHistory]);

        return parent::addYamatoSubsHistory($YamatoSubsHistory);
    }

    /**
     * {@inheritDoc}
     */
    public function removeYamatoSubsHistory(\Plugin\YamatoSubscription\Entity\YamatoSubsHistory $YamatoSubsHistory)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeYamatoSubsHistory', [$YamatoSubsHistory]);

        return parent::removeYamatoSubsHistory($YamatoSubsHistory);
    }
