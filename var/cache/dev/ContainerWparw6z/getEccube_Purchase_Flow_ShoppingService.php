...
include_once $this->targetDirs[3].'/app/Plugin/DeliveryPlus4/Service/PurchaseFlow/Processor/DeliveryChangeValidator.php';
...
$instance->addItemHolderValidator(new \Plugin\DeliveryPlus4\Service\PurchaseFlow\Processor\DeliveryChangeValidator(${($_ = isset($this->services['Plugin\\DeliveryPlus4\\Service\\DeliveryPlusService']) ? $this->services['Plugin\\DeliveryPlus4\\Service\\DeliveryPlusService'] : $this->load('getDeliveryPlusServiceService.php')) && false ?: '_'}));
