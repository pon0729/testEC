...
// Returns the public 'Plugin\ContactManagement4\Controller\Admin\ConfigController' shared autowired service.
...
include_once $this->targetDirs[3].'/app/Plugin/ContactManagement4/Controller/Admin/ConfigController.php';

$this->services['Plugin\\ContactManagement4\\Controller\\Admin\\ConfigController'] = $instance = new \Plugin\ContactManagement4\Controller\Admin\ConfigController(${($_ = isset($this->services['Plugin\\ContactManagement4\\Repository\\ConfigRepository']) ? $this->services['Plugin\\ContactManagement4\\Repository\\ConfigRepository'] : $this->load('getConfigRepository3Service.php')) && false ?: '_'});
