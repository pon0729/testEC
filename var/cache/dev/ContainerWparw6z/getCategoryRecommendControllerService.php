...
// Returns the public 'Plugin\CategoryRecommend4\Controller\CategoryRecommendController' shared autowired service.
...
include_once $this->targetDirs[3].'/app/Plugin/CategoryRecommend4/Controller/CategoryRecommendController.php';
include_once $this->targetDirs[3].'/app/Plugin/CategoryRecommend4/Service/CategoryRecommendService.php';

$a = ${($_ = isset($this->services['Plugin\\CategoryRecommend4\\Repository\\CategoryRecommendProductRepository']) ? $this->services['Plugin\\CategoryRecommend4\\Repository\\CategoryRecommendProductRepository'] : $this->load('getCategoryRecommendProductRepositoryService.php')) && false ?: '_'};

$this->services['Plugin\\CategoryRecommend4\\Controller\\CategoryRecommendController'] = $instance = new \Plugin\CategoryRecommend4\Controller\CategoryRecommendController($a, new \Plugin\CategoryRecommend4\Service\CategoryRecommendService($a));
