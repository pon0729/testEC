...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(['Eccube\\Form\\Type\\AddCartType' => function () {
...
}, 'Plugin\\DeliveryPlus4\\Form\\Type\\Admin\\ConfigType' => function () {
    return ${($_ = isset($this->services['Plugin\\DeliveryPlus4\\Form\\Type\\Admin\\ConfigType']) ? $this->services['Plugin\\DeliveryPlus4\\Form\\Type\\Admin\\ConfigType'] : ($this->services['Plugin\\DeliveryPlus4\\Form\\Type\\Admin\\ConfigType'] = new \Plugin\DeliveryPlus4\Form\Type\Admin\ConfigType())) && false ?: '_'};
}, 'Plugin\\DeliveryPlus4\\Form\\Type\\Admin\\DeliveryPlusDesignType' => function () {
    return ${($_ = isset($this->services['Plugin\\DeliveryPlus4\\Form\\Type\\Admin\\DeliveryPlusDesignType']) ? $this->services['Plugin\\DeliveryPlus4\\Form\\Type\\Admin\\DeliveryPlusDesignType'] : ($this->services['Plugin\\DeliveryPlus4\\Form\\Type\\Admin\\DeliveryPlusDesignType'] = new \Plugin\DeliveryPlus4\Form\Type\Admin\DeliveryPlusDesignType())) && false ?: '_'};
    ...
    return ${($_ = isset($this->services['Plugin\\YamatoPayment4\\Form\\Type\\Admin\\ConfigType']) ? $this->services['Plugin\\YamatoPayment4\\Form\\Type\\Admin\\ConfigType'] : $this->load('getConfigType3Service.php')) && false ?: '_'};
...
}, 8), 'Eccube\\Form\\Type\\Admin\\DeliveryType' => new RewindableGenerator(function () {
    yield 0 => ${($_ = isset($this->services['Plugin\\DeliveryPlus4\\Form\\Extension\\DeliveryExtension']) ? $this->services['Plugin\\DeliveryPlus4\\Form\\Extension\\DeliveryExtension'] : ($this->services['Plugin\\DeliveryPlus4\\Form\\Extension\\DeliveryExtension'] = new \Plugin\DeliveryPlus4\Form\Extension\DeliveryExtension())) && false ?: '_'};
}, 1), 'Eccube\\Form\\Type\\Admin\\ProductClassEditType' => new RewindableGenerator(function () {
    yield 0 => ${($_ = isset($this->services['Plugin\\DeliveryPlus4\\Form\\Extension\\ProductClassEditExtension']) ? $this->services['Plugin\\DeliveryPlus4\\Form\\Extension\\ProductClassEditExtension'] : ($this->services['Plugin\\DeliveryPlus4\\Form\\Extension\\ProductClassEditExtension'] = new \Plugin\DeliveryPlus4\Form\Extension\ProductClassEditExtension())) && false ?: '_'};
}, 1), 'Eccube\\Form\\Type\\Admin\\ProductClassType' => new RewindableGenerator(function () {
    yield 0 => ${($_ = isset($this->services['Plugin\\DeliveryPlus4\\Form\\Extension\\ProductClassExtension']) ? $this->services['Plugin\\DeliveryPlus4\\Form\\Extension\\ProductClassExtension'] : ($this->services['Plugin\\DeliveryPlus4\\Form\\Extension\\ProductClassExtension'] = new \Plugin\DeliveryPlus4\Form\Extension\ProductClassExtension())) && false ?: '_'};
}, 1), 'Eccube\\Form\\Type\\Shopping\\ShippingType' => new RewindableGenerator(function () {
    yield 0 => ${($_ = isset($this->services['Plugin\\DeliveryPlus4\\Form\\Extension\\ShippingExtension']) ? $this->services['Plugin\\DeliveryPlus4\\Form\\Extension\\ShippingExtension'] : $this->load('getShippingExtensionService.php')) && false ?: '_'};
