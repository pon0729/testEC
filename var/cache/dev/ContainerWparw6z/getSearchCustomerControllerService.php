...
// Returns the public 'Plugin\ContactManagement4\Controller\Admin\SearchCustomerController' shared autowired service.
...
include_once $this->targetDirs[3].'/app/Plugin/ContactManagement4/Controller/Admin/SearchCustomerController.php';

$this->services['Plugin\\ContactManagement4\\Controller\\Admin\\SearchCustomerController'] = $instance = new \Plugin\ContactManagement4\Controller\Admin\SearchCustomerController(${($_ = isset($this->services['Eccube\\Repository\\CustomerRepository']) ? $this->services['Eccube\\Repository\\CustomerRepository'] : $this->load('getCustomerRepositoryService.php')) && false ?: '_'});
