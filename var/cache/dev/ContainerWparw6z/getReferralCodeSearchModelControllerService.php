...
// Returns the public 'Plugin\ReferralCode\Controller\Admin\ReferralCodeSearchModelController' shared autowired service.
...
include_once $this->targetDirs[3].'/app/Plugin/ReferralCode/Controller/Admin/ReferralCodeSearchModelController.php';

$this->services['Plugin\\ReferralCode\\Controller\\Admin\\ReferralCodeSearchModelController'] = $instance = new \Plugin\ReferralCode\Controller\Admin\ReferralCodeSearchModelController(${($_ = isset($this->services['Eccube\\Repository\\ProductRepository']) ? $this->services['Eccube\\Repository\\ProductRepository'] : $this->getProductRepositoryService()) && false ?: '_'}, ${($_ = isset($this->services['Eccube\\Repository\\CategoryRepository']) ? $this->services['Eccube\\Repository\\CategoryRepository'] : $this->load('getCategoryRepositoryService.php')) && false ?: '_'});
