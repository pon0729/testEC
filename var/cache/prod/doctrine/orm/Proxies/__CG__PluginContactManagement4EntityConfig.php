 ...
 */
class Config extends \Plugin\ContactManagement4\Entity\Config implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Plugin\\ContactManagement4\\Entity\\Config' . "\0" . 'id', '' . "\0" . 'Plugin\\ContactManagement4\\Entity\\Config' . "\0" . 'name'];
        }
