 ...
 */
class BlogImage extends \Plugin\CMBlog\Entity\BlogImage implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Plugin\\CMBlog\\Entity\\BlogImage' . "\0" . 'id', '' . "\0" . 'Plugin\\CMBlog\\Entity\\BlogImage' . "\0" . 'file_name', '' . "\0" . 'Plugin\\CMBlog\\Entity\\BlogImage' . "\0" . 'sort_no', '' . "\0" . 'Plugin\\CMBlog\\Entity\\BlogImage' . "\0" . 'create_date', '' . "\0" . 'Plugin\\CMBlog\\Entity\\BlogImage' . "\0" . 'Blog', '' . "\0" . 'Plugin\\CMBlog\\Entity\\BlogImage' . "\0" . 'Creator'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (BlogImage $proxy) {
