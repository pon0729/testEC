 ...
 */
class YamatoSubsDiscountCategory extends \Plugin\YamatoSubscription\Entity\YamatoSubsDiscountCategory implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubsDiscountCategory' . "\0" . 'id', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubsDiscountCategory' . "\0" . 'Category'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (YamatoSubsDiscountCategory $proxy) {
