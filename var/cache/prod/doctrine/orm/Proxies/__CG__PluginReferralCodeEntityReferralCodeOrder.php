 ...
 */
class ReferralCodeOrder extends \Plugin\ReferralCode\Entity\ReferralCodeOrder implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Plugin\\ReferralCode\\Entity\\ReferralCodeOrder' . "\0" . 'id', '' . "\0" . 'Plugin\\ReferralCode\\Entity\\ReferralCodeOrder' . "\0" . 'referral_code_id', '' . "\0" . 'Plugin\\ReferralCode\\Entity\\ReferralCodeOrder' . "\0" . 'referral_code', '' . "\0" . 'Plugin\\ReferralCode\\Entity\\ReferralCodeOrder' . "\0" . 'referral_code_name', '' . "\0" . 'Plugin\\ReferralCode\\Entity\\ReferralCodeOrder' . "\0" . 'user_id', '' . "\0" . 'Plugin\\ReferralCode\\Entity\\ReferralCodeOrder' . "\0" . 'email', '' . "\0" . 'Plugin\\ReferralCode\\Entity\\ReferralCodeOrder' . "\0" . 'order_id', '' . "\0" . 'Plugin\\ReferralCode\\Entity\\ReferralCodeOrder' . "\0" . 'pre_order_id', '' . "\0" . 'Plugin\\ReferralCode\\Entity\\ReferralCodeOrder' . "\0" . 'order_date', '' . "\0" . 'Plugin\\ReferralCode\\Entity\\ReferralCodeOrder' . "\0" . 'discount', '' . "\0" . 'Plugin\\ReferralCode\\Entity\\ReferralCodeOrder' . "\0" . 'visible', '' . "\0" . 'Plugin\\ReferralCode\\Entity\\ReferralCodeOrder' . "\0" . 'order_change_status', '' . "\0" . 'Plugin\\ReferralCode\\Entity\\ReferralCodeOrder' . "\0" . 'create_date', '' . "\0" . 'Plugin\\ReferralCode\\Entity\\ReferralCodeOrder' . "\0" . 'update_date'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ReferralCodeOrder $proxy) {
