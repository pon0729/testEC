 ...
 */
class MailHistory extends \Plugin\ContactManagement4\Entity\MailHistory implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Plugin\\ContactManagement4\\Entity\\MailHistory' . "\0" . 'id', '' . "\0" . 'Plugin\\ContactManagement4\\Entity\\MailHistory' . "\0" . 'to_email', '' . "\0" . 'Plugin\\ContactManagement4\\Entity\\MailHistory' . "\0" . 'send_date', '' . "\0" . 'Plugin\\ContactManagement4\\Entity\\MailHistory' . "\0" . 'mail_subject', '' . "\0" . 'Plugin\\ContactManagement4\\Entity\\MailHistory' . "\0" . 'mail_body', '' . "\0" . 'Plugin\\ContactManagement4\\Entity\\MailHistory' . "\0" . 'mail_html_body', '' . "\0" . 'Plugin\\ContactManagement4\\Entity\\MailHistory' . "\0" . 'ContactReply', '' . "\0" . 'Plugin\\ContactManagement4\\Entity\\MailHistory' . "\0" . 'Contact', '' . "\0" . 'Plugin\\ContactManagement4\\Entity\\MailHistory' . "\0" . 'Creator'];
        }
    ...
    public function setToEmail($to_email)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setToEmail', [$to_email]);
    ...
    public function getContactReply()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getContactReply', []);

        return parent::getContactReply();
    }
    ...
    public function setContactReply($ContactReply)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setContactReply', [$ContactReply]);

        return parent::setContactReply($ContactReply);
    }
