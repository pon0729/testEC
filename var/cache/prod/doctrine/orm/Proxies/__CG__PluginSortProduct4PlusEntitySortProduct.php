...
namespace Proxies\__CG__\Plugin\SortProduct4Plus\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class SortProduct extends \Plugin\SortProduct4Plus\Entity\SortProduct implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Plugin\\SortProduct4Plus\\Entity\\SortProduct' . "\0" . 'id', '' . "\0" . 'Plugin\\SortProduct4Plus\\Entity\\SortProduct' . "\0" . 'sort_no'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SortProduct $proxy) {
