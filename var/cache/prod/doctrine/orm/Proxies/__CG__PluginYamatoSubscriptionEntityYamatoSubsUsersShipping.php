 ...
 */
class YamatoSubsUsersShipping extends \Plugin\YamatoSubscription\Entity\YamatoSubsUsersShipping implements \Doctrine\ORM\Proxy\Proxy
{
    /**
     ...
     */
    public static $lazyPropertiesDefaults = ['pre_tracking_number' => NULL, 'tracking_information' => NULL];
    ...
    {
        unset($this->pre_tracking_number, $this->tracking_information);
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubsUsersShipping' . "\0" . 'id', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubsUsersShipping' . "\0" . 'name01', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubsUsersShipping' . "\0" . 'name02', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubsUsersShipping' . "\0" . 'kana01', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubsUsersShipping' . "\0" . 'kana02', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubsUsersShipping' . "\0" . 'company_name', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubsUsersShipping' . "\0" . 'phone_number', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubsUsersShipping' . "\0" . 'postal_code', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubsUsersShipping' . "\0" . 'addr01', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubsUsersShipping' . "\0" . 'addr02', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubsUsersShipping' . "\0" . 'shipping_delivery_name', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubsUsersShipping' . "\0" . 'time_id', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubsUsersShipping' . "\0" . 'shipping_delivery_time', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubsUsersShipping' . "\0" . 'shipping_delivery_date', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubsUsersShipping' . "\0" . 'shipping_date', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubsUsersShipping' . "\0" . 'tracking_number', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubsUsersShipping' . "\0" . 'note', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubsUsersShipping' . "\0" . 'sort_no', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubsUsersShipping' . "\0" . 'create_date', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubsUsersShipping' . "\0" . 'update_date', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubsUsersShipping' . "\0" . 'mail_send_date', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubsUsersShipping' . "\0" . 'YamatoSubsUsersOrder', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubsUsersShipping' . "\0" . 'YamatoSubsUsersOrderItems', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubsUsersShipping' . "\0" . 'Country', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubsUsersShipping' . "\0" . 'Pref', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubsUsersShipping' . "\0" . 'Delivery', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubsUsersShipping' . "\0" . 'ProductClassOfTemp', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubsUsersShipping' . "\0" . 'Creator', 'pre_tracking_number', 'tracking_information'];
        }

        return ['__isInitialized__', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubsUsersShipping' . "\0" . 'id', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubsUsersShipping' . "\0" . 'name01', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubsUsersShipping' . "\0" . 'name02', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubsUsersShipping' . "\0" . 'kana01', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubsUsersShipping' . "\0" . 'kana02', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubsUsersShipping' . "\0" . 'company_name', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubsUsersShipping' . "\0" . 'phone_number', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubsUsersShipping' . "\0" . 'postal_code', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubsUsersShipping' . "\0" . 'addr01', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubsUsersShipping' . "\0" . 'addr02', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubsUsersShipping' . "\0" . 'shipping_delivery_name', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubsUsersShipping' . "\0" . 'time_id', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubsUsersShipping' . "\0" . 'shipping_delivery_time', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubsUsersShipping' . "\0" . 'shipping_delivery_date', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubsUsersShipping' . "\0" . 'shipping_date', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubsUsersShipping' . "\0" . 'tracking_number', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubsUsersShipping' . "\0" . 'note', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubsUsersShipping' . "\0" . 'sort_no', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubsUsersShipping' . "\0" . 'create_date', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubsUsersShipping' . "\0" . 'update_date', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubsUsersShipping' . "\0" . 'mail_send_date', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubsUsersShipping' . "\0" . 'YamatoSubsUsersOrder', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubsUsersShipping' . "\0" . 'YamatoSubsUsersOrderItems', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubsUsersShipping' . "\0" . 'Country', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubsUsersShipping' . "\0" . 'Pref', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubsUsersShipping' . "\0" . 'Delivery', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubsUsersShipping' . "\0" . 'ProductClassOfTemp', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubsUsersShipping' . "\0" . 'Creator'];
    }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (YamatoSubsUsersShipping $proxy) {
  ...
  3 => 'AnnotationReader',
    ...
    public function setPreTrackingNumber($pre_tracking_number)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPreTrackingNumber', [$pre_tracking_number]);

        return parent::setPreTrackingNumber($pre_tracking_number);
    }
    ...
    public function getPreTrackingNumber()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPreTrackingNumber', []);

        return parent::getPreTrackingNumber();
    }
    ...
    public function setTrackingInformation($tracking_information)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTrackingInformation', [$tracking_information]);

        return parent::setTrackingInformation($tracking_information);
    }
    ...
    public function getTrackingInformation()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTrackingInformation', []);

        return parent::getTrackingInformation();
    }
