 ...
 */
class ReferralCodeDeliveryConfig extends \Plugin\ReferralCode\Entity\ReferralCodeDeliveryConfig implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Plugin\\ReferralCode\\Entity\\ReferralCodeDeliveryConfig' . "\0" . 'id', '' . "\0" . 'Plugin\\ReferralCode\\Entity\\ReferralCodeDeliveryConfig' . "\0" . 'normal_order_flg', '' . "\0" . 'Plugin\\ReferralCode\\Entity\\ReferralCodeDeliveryConfig' . "\0" . 'referral_code_order_flg', '' . "\0" . 'Plugin\\ReferralCode\\Entity\\ReferralCodeDeliveryConfig' . "\0" . 'Delivery'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ReferralCodeDeliveryConfig $proxy) {
    ...
    public function setNormalOrderFlg($normal_order_flg)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNormalOrderFlg', [$normal_order_flg]);

        return parent::setNormalOrderFlg($normal_order_flg);
    }
    ...
    public function isNormalOrderEnable()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isNormalOrderEnable', []);

        return parent::isNormalOrderEnable();
    }
    ...
    public function setReferralCodeOrderFlg($referral_code_order_flg)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setReferralCodeOrderFlg', [$referral_code_order_flg]);

        return parent::setReferralCodeOrderFlg($referral_code_order_flg);
    }
    ...
    public function isReferralCodeOrderEnable()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isReferralCodeOrderEnable', []);

        return parent::isReferralCodeOrderEnable();
    }
