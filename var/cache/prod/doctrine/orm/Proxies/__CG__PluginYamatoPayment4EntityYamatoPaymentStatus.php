 ...
 */
class YamatoPaymentStatus extends \Plugin\YamatoPayment4\Entity\YamatoPaymentStatus implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (YamatoPaymentStatus $proxy) {
