...
namespace Proxies\__CG__\Plugin\DeliveryPlus4\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class DeliveryPlusConfig extends \Plugin\DeliveryPlus4\Entity\DeliveryPlusConfig implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Plugin\\DeliveryPlus4\\Entity\\DeliveryPlusConfig' . "\0" . 'name', '' . "\0" . 'Plugin\\DeliveryPlus4\\Entity\\DeliveryPlusConfig' . "\0" . 'value'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DeliveryPlusConfig $proxy) {
