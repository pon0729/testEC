 ...
 */
class ReferralCodeConfig extends \Plugin\ReferralCode\Entity\ReferralCodeConfig implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Plugin\\ReferralCode\\Entity\\ReferralCodeConfig' . "\0" . 'id', '' . "\0" . 'Plugin\\ReferralCode\\Entity\\ReferralCodeConfig' . "\0" . 'delivery_free_amount', '' . "\0" . 'Plugin\\ReferralCode\\Entity\\ReferralCodeConfig' . "\0" . 'subscription_discount_rate'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ReferralCodeConfig $proxy) {
    ...
    public function setDeliveryFreeAmount($delivery_free_amount)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDeliveryFreeAmount', [$delivery_free_amount]);

        return parent::setDeliveryFreeAmount($delivery_free_amount);
    }
    ...
    public function setSubscriptionDiscountRate($subscription_discount_rate)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSubscriptionDiscountRate', [$subscription_discount_rate]);

        return parent::setSubscriptionDiscountRate($subscription_discount_rate);
    }
    ...
    public function getSubscriptionDiscountRate()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSubscriptionDiscountRate', []);

        return parent::getSubscriptionDiscountRate();
    }
