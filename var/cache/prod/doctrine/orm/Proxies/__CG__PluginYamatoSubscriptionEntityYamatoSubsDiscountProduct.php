 ...
 */
class YamatoSubsDiscountProduct extends \Plugin\YamatoSubscription\Entity\YamatoSubsDiscountProduct implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubsDiscountProduct' . "\0" . 'id', '' . "\0" . 'Plugin\\YamatoSubscription\\Entity\\YamatoSubsDiscountProduct' . "\0" . 'Product'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (YamatoSubsDiscountProduct $proxy) {
