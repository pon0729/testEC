...
namespace Proxies\__CG__\Plugin\CategoryRecommend4\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class CategoryRecommendProduct extends \Plugin\CategoryRecommend4\Entity\CategoryRecommendProduct implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Plugin\\CategoryRecommend4\\Entity\\CategoryRecommendProduct' . "\0" . 'id', '' . "\0" . 'Plugin\\CategoryRecommend4\\Entity\\CategoryRecommendProduct' . "\0" . 'comment', '' . "\0" . 'Plugin\\CategoryRecommend4\\Entity\\CategoryRecommendProduct' . "\0" . 'sort_no', '' . "\0" . 'Plugin\\CategoryRecommend4\\Entity\\CategoryRecommendProduct' . "\0" . 'visible', '' . "\0" . 'Plugin\\CategoryRecommend4\\Entity\\CategoryRecommendProduct' . "\0" . 'create_date', '' . "\0" . 'Plugin\\CategoryRecommend4\\Entity\\CategoryRecommendProduct' . "\0" . 'update_date', '' . "\0" . 'Plugin\\CategoryRecommend4\\Entity\\CategoryRecommendProduct' . "\0" . 'Product', '' . "\0" . 'Plugin\\CategoryRecommend4\\Entity\\CategoryRecommendProduct' . "\0" . 'Category'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CategoryRecommendProduct $proxy) {
