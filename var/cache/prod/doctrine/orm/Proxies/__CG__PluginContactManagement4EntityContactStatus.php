 ...
 */
class ContactStatus extends \Plugin\ContactManagement4\Entity\ContactStatus implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ContactStatus $proxy) {
