 ...
 */
class YamatoOrder extends \Plugin\YamatoPayment4\Entity\YamatoOrder implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Plugin\\YamatoPayment4\\Entity\\YamatoOrder' . "\0" . 'id', '' . "\0" . 'Plugin\\YamatoPayment4\\Entity\\YamatoOrder' . "\0" . 'Order', '' . "\0" . 'Plugin\\YamatoPayment4\\Entity\\YamatoOrder' . "\0" . 'memo01', '' . "\0" . 'Plugin\\YamatoPayment4\\Entity\\YamatoOrder' . "\0" . 'memo02', '' . "\0" . 'Plugin\\YamatoPayment4\\Entity\\YamatoOrder' . "\0" . 'memo03', '' . "\0" . 'Plugin\\YamatoPayment4\\Entity\\YamatoOrder' . "\0" . 'memo04', '' . "\0" . 'Plugin\\YamatoPayment4\\Entity\\YamatoOrder' . "\0" . 'memo05', '' . "\0" . 'Plugin\\YamatoPayment4\\Entity\\YamatoOrder' . "\0" . 'memo06', '' . "\0" . 'Plugin\\YamatoPayment4\\Entity\\YamatoOrder' . "\0" . 'memo07', '' . "\0" . 'Plugin\\YamatoPayment4\\Entity\\YamatoOrder' . "\0" . 'memo08', '' . "\0" . 'Plugin\\YamatoPayment4\\Entity\\YamatoOrder' . "\0" . 'memo09', '' . "\0" . 'Plugin\\YamatoPayment4\\Entity\\YamatoOrder' . "\0" . 'memo10'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (YamatoOrder $proxy) {
