...
include_once $this->targetDirs[3].'/app/Plugin/Api/Controller/Admin/WebHookController.php';

$this->services['Plugin\\Api\\Controller\\Admin\\WebHookController'] = $instance = new \Plugin\Api\Controller\Admin\WebHookController(${($_ = isset($this->services['Plugin\\Api\\Repository\\WebHookRepository']) ? $this->services['Plugin\\Api\\Repository\\WebHookRepository'] : $this->getWebHookRepositoryService()) && false ?: '_'});
