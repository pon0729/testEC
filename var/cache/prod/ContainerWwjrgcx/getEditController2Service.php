...
// Returns the public 'Plugin\ReferralCode\Controller\Admin\EditController' shared autowired service.
...
include_once $this->targetDirs[3].'/app/Plugin/ReferralCode/Controller/Admin/EditController.php';

$this->services['Plugin\\ReferralCode\\Controller\\Admin\\EditController'] = $instance = new \Plugin\ReferralCode\Controller\Admin\EditController(${($_ = isset($this->services['Plugin\\ReferralCode\\Repository\\ReferralCodeRepository']) ? $this->services['Plugin\\ReferralCode\\Repository\\ReferralCodeRepository'] : $this->load('getReferralCodeRepositoryService.php')) && false ?: '_'}, ${($_ = isset($this->services['Plugin\\ReferralCode\\Repository\\ReferralCodeDetailRepository']) ? $this->services['Plugin\\ReferralCode\\Repository\\ReferralCodeDetailRepository'] : $this->load('getReferralCodeDetailRepositoryService.php')) && false ?: '_'}, ${($_ = isset($this->services['Plugin\\ReferralCode\\Service\\ReferralCodeService']) ? $this->services['Plugin\\ReferralCode\\Service\\ReferralCodeService'] : $this->load('getReferralCodeServiceService.php')) && false ?: '_'});
