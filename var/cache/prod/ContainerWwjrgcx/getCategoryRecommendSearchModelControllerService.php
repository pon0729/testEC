...
// Returns the public 'Plugin\CategoryRecommend4\Controller\CategoryRecommendSearchModelController' shared autowired service.
...
include_once $this->targetDirs[3].'/app/Plugin/CategoryRecommend4/Controller/CategoryRecommendSearchModelController.php';

$this->services['Plugin\\CategoryRecommend4\\Controller\\CategoryRecommendSearchModelController'] = $instance = new \Plugin\CategoryRecommend4\Controller\CategoryRecommendSearchModelController(${($_ = isset($this->services['Eccube\\Repository\\CategoryRepository']) ? $this->services['Eccube\\Repository\\CategoryRepository'] : $this->load('getCategoryRepositoryService.php')) && false ?: '_'}, ${($_ = isset($this->services['Eccube\\Repository\\ProductRepository']) ? $this->services['Eccube\\Repository\\ProductRepository'] : $this->getProductRepositoryService()) && false ?: '_'});
